Public Class RptAirtLotGP

    Function RptAirLotGP(ByVal UID As String, ByVal sUid As String, ByVal ds As DataSet) As String
        ...
        Try
            ...
            If PrintType = 11 Or PrintType = 12 Then 'LOT GROSS PROFIT DETAIL REPORT
                ...
                With ds.Tables(TblIndex).Rows(0)
                    ...
                    objExcel.Cells(iRow + 3, iCol).value = "FLIGHT: " & .Item("VslName").ToString
            ...
            Else
                If PrintType = 6 Or PrintType = 10 Or PrintType = 13 Then 'By Period or By Vessel or By MBL No
                    If TypeRefId = 0 Then
                        ...
                        If ds.Tables(1).Rows.Count <= 0 Or ds.Tables(0).Rows.Count > 0 Then
                            While i < ds.Tables(TblIndex).Rows.Count
                                ...
                                If i = 10 Then
                                    objExcel.Cells(iRow + 2, 1).value = "FLIGHT: " & ds.Tables(TblIndex).Rows(i).Item("VslName") & "      AIRLINE: " & ds.Tables(TblIndex).Rows(i).Item("CarrName") & "      DATE: " & Format(ds.Tables(TblIndex).Rows(i).Item("VslOnBoard"), "dd/mm/yy")
                                End If
                                ...
                                End If
                                objExcel.Cells(iRow, iCol + 2).value = "CNEE"
                                objExcel.Cells(iRow, iCol + 3).value = "DESTINATION"
                                objExcel.Cells(iRow, iCol + 4).value = "GROSS WEIGHT"
                                objExcel.Cells(iRow, iCol + 5).value = "CHARGES WEIGHT"

                                objExcel.Cells(iRow, iCol + 6).value = "INCOME"
                                objExcel.Cells(iRow, iCol + 7).value = "COST"

                                objExcel.Cells(iRow, iCol + 8).value = "PROFIT AFTER SHARE"

                                objExcel.Cells(iRow, iCol + 9).value = "GP"
                                objExcel.Cells(iRow, iCol + 10).value = "GP MARGIN(%)"

                                objExcel.Cells(iRow, iCol + 11).value = "LOCAL PROFIT"

                                objExcel.Cells(iRow, iCol + 12).value = "INCOME" & Chr(10) & Chr(13) & "A/C EX-RATE"
                                objExcel.Cells(iRow, iCol + 13).value = "COST" & Chr(10) & Chr(13) & "A/C EX-RATE"
                                objExcel.Cells(iRow, iCol + 14).value = "GP" & Chr(10) & Chr(13) & "A/C EX-RATE"
                                objExcel.Cells(iRow, iCol + 15).value = "GP MARGIN(%)" & Chr(10) & Chr(13) & "A/C EX-RATE"
                                objExcel.Cells(iRow, iCol + 16).value = "A/C EX-RATE"

                                objExcel.Cells(iRow, iCol + 17).value = "HOUSE BL"
                                objExcel.Cells(iRow, iCol + 18).value = "BOOKING ID"
                                objExcel.Cells(iRow, iCol + 19).value = "SHIPPER"
                                objExcel.Cells(iRow, iCol + 20).value = "CTNR SIZE"
                                objExcel.Cells(iRow, iCol + 21).value = "FEUS"
                                objExcel.Cells(iRow, iCol + 22).value = "CBM"
                                objExcel.Cells(iRow, iCol + 23).value = "HANDLE BY"
                                objExcel.Cells(iRow, iCol + 24).value = "NOMINATION OFFICE"
                                ...
                                objExcel.Range(objExcel.Cells(iRow, iCol + 10), objExcel.Cells(iRow, iCol + 10)).Font.Bold = True
                                objExcel.Range(objExcel.Cells(iRow, iCol + 13), objExcel.Cells(iRow, iCol + 13)).Font.Bold = True
                                objExcel.Range(objExcel.Cells(iRow, iCol + 15), objExcel.Cells(iRow, iCol + 15)).Font.Bold = True
                                objExcel.Range(objExcel.Cells(iRow, 1), objExcel.Cells(iRow, iCol + 24)).Borders(9).LineStyle = 1
                                objExcel.Range(objExcel.Cells(iSRow, iCol), objExcel.Cells(iSRow + 1, iCol + 24)).Font.Bold = True
                                objExcel.Range(objExcel.Cells(iSRow, iCol), objExcel.Cells(iSRow + 1, iCol + 24)).HorizontalAlignment = -4108
                                ...
                                For i = 0 To ds.Tables(TblIndex).Rows.Count - 1
                                    ...
                                    objExcel.Cells(iRow, iCol + 2).value = ds.Tables(TblIndex).Rows(i).Item("ConStr")
                                    objExcel.Cells(iRow, iCol + 3).value = ds.Tables(TblIndex).Rows(i).Item("DestStr")
                                    objExcel.Cells(iRow, iCol + 4).value = ds.Tables(TblIndex).Rows(i).Item("GrossWgt")
                                    objExcel.Cells(iRow, iCol + 5).value = ds.Tables(TblIndex).Rows(i).Item("ChgWgt")

                                    objExcel.Cells(iRow, iCol + 6).value = FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhIncome"), "2")
                                    Total1 = Total1 + FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhIncome"), "2")

                                    objExcel.Cells(iRow, iCol + 7).value = FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhOutlay"), "2")
                                    Total2 = Total2 + FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhOutlay"), "2")

                                    objExcel.Cells(iRow, iCol + 8).value = FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ProfitAS"), "2")

                                    objExcel.Cells(iRow, iCol + 9).value = FormatNumber(FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhIncome"), "2") - FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhOutlay"), "2"), "2")
                                    ...
                                    If ds.Tables(TblIndex).Rows(i).Item("ShhIncome") <> 0 Then
                                        objExcel.Cells(iRow, iCol + 10).value = FormatNumber((ds.Tables(TblIndex).Rows(i).Item("ShhIncome") - ds.Tables(TblIndex).Rows(i).Item("ShhOutlay")) / ds.Tables(TblIndex).Rows(i).Item("ShhIncome") * 100, 2)
                                    ...
                                    Else
                                        objExcel.Cells(iRow, iCol + 10).value = 0
                                    End If

                                    objExcel.Cells(iRow, iCol + 11).value = ds.Tables(TblIndex).Rows(i).Item("LocalProfit")

                                    ' Account Rate
                                    objExcel.Cells(iRow, iCol + 12).value = FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate"), "2")
                                    Total5 = Total5 + FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate"), "2")

                                    objExcel.Cells(iRow, iCol + 13).value = FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhOutlayAccRate"), "2")
                                    Total6 = Total6 + FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhOutlayAccRate"), "2")

                                    objExcel.Cells(iRow, iCol + 14).value = FormatNumber(FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate"), "2") - FormatNumber(ds.Tables(TblIndex).Rows(i).Item("ShhOutlayAccRate"), "2"), "2")
                                    ...
                                    If objExcel.Cells("ShhIncomeAccRate") <> 0 Then
                                        objExcel.Cells(iRow, iCol + 15).value = FormatNumber((ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate") - ds.Tables(TblIndex).Rows(i).Item("ShhOutlayAccRate")) / ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate") * 100, 2)
                                        Total8 = Total8 + FormatNumber((ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate") - ds.Tables(TblIndex).Rows(i).Item("ShhOutlayAccRate")) / ds.Tables(TblIndex).Rows(i).Item("ShhIncomeAccRate") * 100, 2)
                                    Else
                                        objExcel.Cells(iRow, iCol + 15).value = 0
                                    End If

                                    objExcel.Cells(iRow, iCol + 16).value = ds.Tables(TblIndex).Rows(i).Item("AccRate")

                                    objExcel.Cells(iRow, iCol + 17).value = ds.Tables(TblIndex).Rows(i).Item("ShhBLNo")
                                    objExcel.Cells(iRow, iCol + 18).value = ds.Tables(TblIndex).Rows(i).Item("ShhSoNo")
                                    objExcel.Cells(iRow, iCol + 19).value = ds.Tables(TblIndex).Rows(i).Item("ShhShipper")
                                    objExcel.Cells(iRow, iCol + 20).value = ds.Tables(TblIndex).Rows(i).Item("ShhCtnrType")
                                    objExcel.Cells(iRow, iCol + 21).value = ds.Tables(TblIndex).Rows(i).Item("ShhCtnrFEUS")
                                    objExcel.Cells(iRow, iCol + 22).value = ds.Tables(TblIndex).Rows(i).Item("ShhCtnrCBM")
                                    objExcel.Cells(iRow, iCol + 23).value = ds.Tables(TblIndex).Rows(i).Item("HandleBy")
                                    objExcel.Cells(iRow, iCol + 18).value = ds.Tables(TblIndex).Rows(i).Item("NomOffice")
                                ...
                                objExcel.Range(objExcel.Cells(iRow, 11), objExcel.Cells(iRow, 6)).Activate()
                                objExcel.ActiveCell.FormulaR1C1 = "=RC[-1]/RC[-3]*100"

                                ' Account Rate
                                objExcel.Range(objExcel.Cells(iRow, 15), objExcel.Cells(iRow, 10)).Activate()
                                objExcel.ActiveCell.FormulaR1C1 = "=RC[-1]/RC[-3]*100"

                                objExcel.Range(objExcel.Cells(iRow, iCol + 6), objExcel.Cells(iRow, iCol + 15)).NumberFormatLocal = "#,##0.00_ "
                                objExcel.Range(objExcel.Cells(iRow, iCol + 6), objExcel.Cells(iRow, iCol + 15)).Borders(8).LineStyle = 1
                    ...
                    Else
                        ...
                        objExcel.Cells(iRow, iCol + 22).value = "CBM"
                        objExcel.Cells(iRow, iCol + 23).value = "HANDLE BY"
                        objExcel.Cells(iRow, iCol + 18).value = "NOMINATION OFFICE"
                        ...
                        objExcel.Range(objExcel.Cells(iRow, 1), objExcel.Cells(iRow, iCol + 24)).Borders(9).LineStyle = 1
                        objExcel.Range(objExcel.Cells(iSRow, iCol), objExcel.Cells(iSRow + 1, iCol + 24)).Font.Bold = True
                        objExcel.Range(objExcel.Cells(iSRow, iCol), objExcel.Cells(iSRow, iCol + 24)).Merge()
                        objExcel.Range(objExcel.Cells(iSRow + 1, iCol), objExcel.Cells(iSRow + 1, iCol + 5)).Merge()
                        objExcel.Range(objExcel.Cells(iSRow + 3, iCol), objExcel.Cells(iSRow + 3, iCol + 5)).Merge()
                        ...
                        While i < ds.Tables(TblIndex).Rows.Count
                            ...
                            objExcel.Application.Cells(iRow, iCol + 17).value = ds.Tables(TblIndex).Rows(i).Item("ShhBLNo")
                            objExcel.Application.Cells(iRow, iCol + 18).value = ds.Tables(TblIndex).Rows(i).Item("ShhSoNo")
                            objExcel.Application.Cells(iRow, iCol + 19).value = ds.Tables(TblIndex).Rows(i).Item("ShhShipper")
                            objExcel.Application.Cells(iRow, iCol + 20).value = ds.Tables(TblIndex).Rows(i).Item("ShhCtnrType")
                            objExcel.Application.Cells(iRow, iCol + 21).value = ds.Tables(TblIndex).Rows(i).Item("ShhCtnrFEUS")
                            objExcel.Application.Cells(iRow, iCol + 22).value = ds.Tables(TblIndex).Rows(i).Item("ShhCtnrCBM")
                            objExcel.Application.Cells(iRow, iCol + 23).value = ds.Tables(TblIndex).Rows(i).Item("HandleBy")
                            objExcel.Application.Cells(iRow, iCol + 18).value = ds.Tables(TblIndex).Rows(i).Item("NomOffice")
                        ...
                        objExcel.Range(objExcel.Cells(iRow, 11), objExcel.Cells(iRow, 11)).Activate()
                        objExcel.ActiveCell.FormulaR1C1 = "=RC[-1]/RC[-4]*100"

                        ' Account Rate
                        objExcel.Range(objExcel.Cells(iRow, 16), objExcel.Cells(iRow, 16)).Activate()
                        objExcel.ActiveCell.FormulaR1C1 = "=RC[-1]/RC[-3]*100"

                        objExcel.Range(objExcel.Cells(iRow, iCol + 2), objExcel.Cells(iRow, iCol + 15)).NumberFormatLocal = "#,##0.00_ "
                        objExcel.Range(objExcel.Cells(iRow, iCol + 2), objExcel.Cells(iRow, iCol + 15)).Borders(8).LineStyle = 1
