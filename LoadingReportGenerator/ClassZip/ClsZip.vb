Public Class ClsZip
    ...
    Sub ExportZip(ByVal UID As String, ByVal RptID As String, ByVal RptDataSet As DataSet, ByVal isEmail As Integer, ByVal UsrDtl As String(), ByVal inParaNames As String(), ByVal inParaValues As String())
        ...
        Select Case RptID
            Case "RptAMS"
                ...
                Dim rpt As New RptAMS
                rptFile = rpt.RptAMS(UID, RptDataSet)
                rptName = "AMS Submission"
